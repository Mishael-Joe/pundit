...
import { HiMenuAlt1, CloseMenuIcon, CgProfile } from '@/app/utils/icons/icons';
...
function ResponsiveNav() {
    ...
    return (
        <div>
            <button onClick={toggleMenu}><HiMenuAlt1 /></button>

            {isOpen && (
                <aside className="fixed top-0 left-0 flex flex-col w-64 z-50 overflow-y-auto h-screen px-5 py-4 bg-white dark:bg-gray-900 dark:border-gray-700">
                <div className="flex justify-between">
                    <span className="font-Rubik font-bold text-xl dark:text-green-400 transition ease-in-out delay-100">WiSchool</span>
                    <span onClick={toggleMenu} className="dark:text-slate-100"><CloseMenuIcon /></span>
                </div>
                ...
                <div className="flex flex-col justify-between flex-1 mt-6">
                    <nav className="flex-1 -mx-3 space-y-3 ">
                        ...
                        <a className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                            ...
                            <span className="mx-2 text-sm font-medium">Schedules</span>
                        </a>
