...
const footerLinks = {
  Home: [
    ...
    { id: 3, label: "Training", href: "#" },
    { id: 4, label: "Resources", href: "#" },
    { id: 5, label: "About us", href: "#" }
  ],
  SME: [
    { id: 1, label: "SME", href: "#" },
    { id: 2, label: "Solution", href: "#" },
    { id: 3, label: "Reviews", href: "#" },
    { id: 4, label: "Blog", href: "#" }
  ],
  "Contact Us": [
    { id: 1, label: "Contact Us", href: "#" },
    { id: 2, label: "Place A Call", href: "#" },
    { id: 3, label: "E-mail", href: "#" },
    { id: 4, label: "Wischool@gmail.com", href: "#" },
    { id: 1, label: "FAQ", href: "#" }
  ],
  "Job Opening": [
    { id: 1, label: "Job Opening", href: "#" },
    { id: 2, label: "News", href: "#" },
    { id: 3, label: "Research", href: "#" }
  ],
  "T & C": [
    { id: 1, label: "UK Privacy Policy", href: "#" },
    { id: 2, label: "Terms Of Use", href: "#" }
  ]
};

function FooterWriteUp() {
  return <div className={`w-48 font-Rubik py-0 ps-3 md:ps-0`}>{footerWriteUp.writeUp}</div>;
}
...
function FooterLinks() {
  const listItemsA = footerLinks.Home.map((item) => (
    <li key={item.id} className="py-0.5 ps-3 font-Roboto">
  ...
  const listItemsB = footerLinks.SME.map((item) => (
    <li key={item.id} className="py-0.5 ps-3 font-Roboto">
      <Link href={item.href} className="hover:text-green-400">
        {item.label}
      </Link>
  ...
  const listItemsC = footerLinks["Contact Us"].map((item) => (
    <li key={item.id} className="py-0.5 ps-3 font-Roboto">
      <Link href={item.href} className="hover:text-green-400">
        {item.label}
      </Link>
  ...
  const listItemsD = footerLinks["Job Opening"].map((item) => (
    <li key={item.id} className="py-0.5 ps-3 font-Roboto">
      <Link href={item.href} className="hover:text-green-400">
        {item.label}
      </Link>
  ...
  const listItemsE = footerLinks["T & C"].map((item) => (
    <li key={item.id} className="py-0.5 ps-3 font-Roboto">
      <Link href={item.href} className="hover:text-green-400">
        {item.label}
      </Link>
  ...
  return (
    <>
    <ul className="ps-3 py-1 md:p-0">{listItemsA}</ul>
    <ul className="ps-3 py-1 md:p-0">{listItemsB}</ul>
    <ul className="ps-3 py-1 md:p-0">{listItemsC}</ul>
    <ul className="ps-3 py-1 md:p-0 hidden lg:inline-block">{listItemsD}</ul>
    <ul className="ps-3 py-1 md:p-0 hidden lg:inline-block">{listItemsE}</ul>
    </>
  )
}
...
function Footer() {
  return (
    <div className="footer__grid transition ease-in-out delay-300">
      <div className="flex__Footer py-6 ps-3 text-slate-100 dark:bg-[#131417]">
        <div className="ps-3">
          <div className="text-3xl text-green-500 ps-3 md:ps-0 font-bold">WiSchool</div>
          <FooterWriteUp />
          <div className="flex w-44 ps-3 md:ps-0 py-1">
