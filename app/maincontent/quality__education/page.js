...
function QualityEduNote__md() {
    return (
        <div className={"hidden md:font-semibold md:absolute md:top-32 md:w-48 md:shadow-lg md:bg-slate-50  md:rounded-md md:p-2 md:text-center md:inline md:right-64 lg:right-72 dark:bg-green-900 transition ease-in-out delay-100"}>
            <QualityEdu__Note__md />
        </div>
    )
}
...
function QualityEduNote__sm() {
    return (
        <div className={"hidden md:font-semibold md:absolute md:bg-slate-100 md:p-2 md:rounded-md md:w-32 md:h-auto md:text-center md:shadow-lg md:inline md:top-64 md:text-xs md:right-4 lg:right-16 dark:bg-green-900 transition ease-in-out delay-100"}>
            <QualityEdu__Note__sm />
        </div>
    )
}
...
export default function Quality__Education() {
    return (
        <header className={"grid sm:flex-row pt-5 md:-mt-3 dark:bg-[#0c2313fa] transition ease-in-out delay-100 dark:text-slate-100"}>
        <QualityEduNote__lg />
        <SecondFlex__item />
        </header>
    )
